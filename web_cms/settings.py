...
SITE_TITLE = "CCFA MIBC"
ADMINS = (
    ('Randall Schwager', 'schwager@hsph.harvard.edu'),
)
MANAGERS = ADMINS

# Hosts/domain names that are valid for this site; required if DEBUG is False
# See https://docs.djangoproject.com/en/1.5/ref/settings/#allowed-hosts
ALLOWED_HOSTS = [ "ccfa.rc.fas.harvard.edu",
                  "ccfa02.rc.fas.harvard.edu",
                  "140.247.151.7",
                  "localhost",
                  "127.0.0.1" ]
...
# DATABASES #
#############
# Please do not edit this, but instead use the top-level (anadama)
# setup.py script like so:
#
# python setup.py mysql
DATABASES = {
    "default": {
        # Add "postgresql_psycopg2", "mysql", "sqlite3" or "oracle".
        "ENGINE": "django.db.backends.mysql",
        # DB name or path to database file if using sqlite3.
        "NAME": "anadama_web_cms",
